...
#   timestamp: 2026-02-27T20:18:35+00:00
...
class StringOption(BaseModel):
    ...
    infoText: str | None = Field(
        None,
        description='The description that is displayed when the participant hovers over the option. This does not accept markdown. Applies to responses that use StringOption, including DropdownResponse, RadioResponse, CheckboxResponse, ButtonsResponse, RankingResponse, and MatrixResponse.',
    )
    label: str = Field(
...
class BrowserRules(BaseModel):
    ...
    blockedMessage: str | None = Field(
        None,
        description='Optional message to be displayed when browser criterias are not met.',
    )  # End of class
...
class DeviceRules(BaseModel):
    ...
    blockedMessage: str | None = Field(
        None,
        description='Optional message to be displayed when device criterias are not met.',
    )  # End of class
...
class InputRules(BaseModel):
    ...
    blockedMessage: str | None = Field(
        None,
        description='Optional message to be displayed when input criterias are not met.',
    )  # End of class
